...
| `/api/telemetry/summary` | GET | Summarize spend and usage by harness/provider/model/repo/skill |
| `/api/telemetry/runs` | GET/POST | List normalized telemetry runs or ingest producer telemetry |
| `/api/telemetry/import` | POST | Backfill telemetry from local traces and session artifacts |
