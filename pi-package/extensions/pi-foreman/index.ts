...
export default function foremanExtension(pi: ExtensionAPI) {
  ...
  // No command registration. The skill (foreman/SKILL.md) handles /foreman.
  // The extension provides tools + widget + shortcuts only.
  // foremanMode activates automatically when the service is healthy.
}
